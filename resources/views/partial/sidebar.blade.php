      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
                <li class="active"><a href="{{route('table_barang.index')}}"><i class="fa fa-circle-o"></i>Barang</a></li>
                <li class="active"><a href="{{route('kategori.index')}}"><i class="fa fa-circle-o"></i>Kategori</a></li>
                <li class="active"><a href="{{route('gambar.index')}}"><i class="fa fa-circle-o"></i>Gambar</a></li>
          </ul>
        </li>
      </ul>
    </section>
